...
<div class="container mt-4">
    ...
    <a href="<?php echo e(route('employee.products.create')); ?>" class="btn btn-primary mb-3">Add New Product</a>

    <!-- Filter Section -->
    <form method="GET" action="<?php echo e(route('employee.products.index')); ?>" class="mb-4">
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="<?php echo e(route('employee.products.index')); ?>" class="btn btn-secondary ms-2">Reset</a>
            </div>
        </div>
    </form>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('employee.products.edit', $product->id)); ?>" class="btn btn-info btn-sm">Edit</a>
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Employee/products/index.blade.php ENDPATH**/ ?>