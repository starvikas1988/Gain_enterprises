                ...
                <div class="col-xxl-4 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-header pt-4 pb-4 text-center">
                            <a href="<?php echo e(route('employee.login')); ?>">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="<?php echo e(route('employee.login.submit')); ?>">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(route('employee.password.request')); ?>" class="btn btn-primary">Forgot Password?</a>
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/auth/employeelogin.blade.php ENDPATH**/ ?>