        ...
        <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
            ...
            <td class="d-flex gap-2">
              ...
              <a href="<?php echo e(route('admin.store.edit', ['id' => $row->id])); ?>"
              ...
              <a href="<?php echo e(route('admin.store.show', ['id' => $row->id])); ?>"
              ...
              <a href="<?php echo e(route('admin.store.delete', ['id' => $row->id])); ?>"
...
<?php /**PATH C:\xampp\htdocs\logisticsApp\resources\views/admin/store/table.blade.php ENDPATH**/ ?>