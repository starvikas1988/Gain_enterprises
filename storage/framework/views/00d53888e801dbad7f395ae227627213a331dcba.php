    ...
    <tbody> 
      ...
      <?php if($result->isNotEmpty()): ?>
        ...
        <tr>
          ...
          <td>
            <a href="<?php echo e(route('admin.admin.edit',['id'=>$row->id])); ?>" title="edit" class="action-icon"><i class="mdi mdi-square-edit-outline"></i></a> 
            <a href="<?php echo e(route('admin.admin.delete',['id'=>$row->id])); ?>" title="delete" class="action-icon" onclick="return myFunction();" ><i class="mdi mdi-trash-can"></i></a> 
          </td>
        </tr>
...
</div><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/admin/admin/table.blade.php ENDPATH**/ ?>