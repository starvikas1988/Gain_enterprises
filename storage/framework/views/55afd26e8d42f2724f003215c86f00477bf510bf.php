            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-xl-3">
                        ...
                        <input type="search" class="form-control" id="s_key" placeholder="Name, Email, Phone">
                    </div>		
                    ...
                    <div class="col-xl-3">
                        <div class="text-xl-end mt-xl-0 mt-2">
                            <a href="<?php echo e(route('admin.store.create')); ?>" class="btn btn-danger mb-2 me-2">
                                <i class="mdi mdi-store-plus me-1"></i> Add Store
                            </a> 
                        </div>
                    </div><!-- end col-->
                </div>
...
<script>
    ...
    function data_table(page_url) {
        ...
        var base_url = '<?php echo e(route("admin.stores")); ?>';
        if (page_url) {
            base_url = page_url;
            current_url = page_url;
        }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\logisticsApp\resources\views/admin/store/header.blade.php ENDPATH**/ ?>