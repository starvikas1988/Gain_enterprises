...
<div class="container mt-4">
    ...
    <!-- Product Form -->
    <form action="<?php echo e(route('employee.products.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Employee/products/create.blade.php ENDPATH**/ ?>