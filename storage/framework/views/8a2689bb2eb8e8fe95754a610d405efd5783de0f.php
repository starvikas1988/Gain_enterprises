...
<div class="container mt-4">
    ...
    <a href="<?php echo e(route('employee.stocks.index')); ?>" class="btn btn-secondary mb-3">Back to Stocks</a>

    <!-- Stock Creation Form -->
    <form action="<?php echo e(route('employee.stocks.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<script>
   document.getElementById('category_id').addEventListener('change', function () {
    ...
    if (categoryId) {
        fetch(`/employee/stocks/products/${categoryId}`)
            .then(response => {
                if (!response.ok) {
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/employee/stocks/create.blade.php ENDPATH**/ ?>