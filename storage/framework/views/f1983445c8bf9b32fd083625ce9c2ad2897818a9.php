...
<div class="container mt-4">
    ...
    <a href="<?php echo e(route('employee.tables.index')); ?>" class="btn btn-secondary mb-3">Back to Table Management</a>

    <!-- Table Edit Form -->
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('employee.tables.update', $table->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="capacity" name="capacity" class="form-control" 
                           value="<?php echo e(old('capacity', $table->capacity)); ?>" min="1" required>
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Employee/tables/edit.blade.php ENDPATH**/ ?>