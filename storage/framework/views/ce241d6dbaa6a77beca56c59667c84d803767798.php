...
<div class="container mt-4">
    ...
    <!-- Product Edit Form -->
    <form action="<?php echo e(route('restaurant.products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.restaurant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Restaurant/products/edit.blade.php ENDPATH**/ ?>