                   ...
                   <div class="col-xl-3 mb-2">
                    ...
                    <div class="col-xl-3">
                        <div class="text-xl-end mt-xl-0 mt-2">
                         <a href="<?php echo e(route('admin.user.create')); ?>" class="btn btn-danger mb-2 me-2"><i class="mdi mdi-basket me-1"></i> Add Customer</a> 
                        </div>
                    </div><!-- end col-->
                </div>
...
<script>
    ...
    function data_table(page_url){
        ...
        var base_url = '<?php echo e(route("admin.users")); ?>';
        if(page_url)
        {
            base_url = page_url;
            current_url = page_url;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/admin/user/header.blade.php ENDPATH**/ ?>