...
<div class="container mt-4">
    ...
    <!-- Edit Form -->
    <form method="POST" action="<?php echo e(route('restaurant.categories.update', $category->id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
            ...
            <?php if($category->icon): ?>
                <div class="mt-2">
                    <img src="<?php echo e(asset(($category->icon))); ?>" alt="Category Icon" width="100" height="100">
...
<?php echo $__env->make('layouts.restaurant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Restaurant/categories/edit.blade.php ENDPATH**/ ?>