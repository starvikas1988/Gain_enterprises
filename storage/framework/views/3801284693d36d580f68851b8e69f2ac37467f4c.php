                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('restaurant.orders.view', $order->id)); ?>" class="btn btn-sm btn-primary">View</a>
                            </td>
                        </tr>
...
<script>
    ...
    $.ajax({
        url: "<?php echo e(route('restaurant.orders.updateStatus')); ?>",
        type: "POST",
        data: {
...
$(document).on("click", ".change-order-status", function() {
    ...
    $.ajax({
        url: "<?php echo e(route('restaurant.orders.changeStatus')); ?>",
        type: "POST",
        data: {
            _token: "<?php echo e(csrf_token()); ?>",
            order_id: orderId,
