...
<head>
        <meta charset="utf-8" />
        <title><?php echo e(env('APP_NAME')); ?> | Employee Panel</title>
        ...
        <!-- third party css -->
        <link href="<?php echo e(asset('public/backend/assets/css/vendor/jquery-jvectormap-1.2.2.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- third party css end -->
        <!-- App css -->
        ...
        <link href="<?php echo e(asset('public/backend/assets/js/summernote/summernote-bs5.css')); ?>" rel="stylesheet" type="text/css" />
		<style>.tox-notification { display: none !important }
			.table-nowrap td, .table-nowrap th { white-space: normal!important; }
			.uppercase { text-transform: uppercase; }
			/*.simplebar-content-wrapper {background: linear-gradient(to right,rgba(255,255,255,.5),rgba(255,255,255,.5)),url(<?php echo e(asset('public/backend/assets/images/test-back.png')); ?> ) no-repeat center bottom;*/
		</style>
    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
            <?php echo $__env->make('employee.include.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- Left Sidebar End -->

            <div class="content-page">
                <div class="content">
                    <!-- Topbar Start -->
                    <?php echo $__env->make('employee.include.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!-- end Topbar -->
        ...
        <!-- demo app -->
        <script src="<?php echo e(asset('public/backend/assets/js/pages/demo.dashboard.js')); ?>"></script>
        <!-- end demo js-->
		...
		<script type="text/javascript">
			$('.livecustomer').select2({
				...
				ajax: {
					url: '<?php echo e(route("customersearch")); ?>',
					dataType: 'json',
					delay: 250,
...
</html><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/layouts/employee.blade.php ENDPATH**/ ?>