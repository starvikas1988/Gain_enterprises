    ...
    <ul class="list-unstyled topbar-menu float-end mb-0">
        ...
        <li class="dropdown notification-list">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                ...
                <!-- item-->
                <a href="<?php echo e(route('employee.myprofile')); ?>" class="dropdown-item notify-item">
                    <i class="mdi mdi-account-circle me-1"></i>
                    <span>My Account</span>
                </a>
                <!-- item-->
                <a href="<?php echo e(route('employee.changepassword')); ?>" class="dropdown-item notify-item">
                    <i class="mdi mdi-account-circle me-1"></i>
                    <span>Change Password</span>
                </a>
                <!-- item-->
                <a href="<?php echo e(route('employee.logout')); ?>" class="dropdown-item notify-item">
...
</div><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/employee/include/header.blade.php ENDPATH**/ ?>