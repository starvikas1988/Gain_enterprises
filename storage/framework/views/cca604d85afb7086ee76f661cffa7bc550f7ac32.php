...
<div class="container mt-4">
    <div class="card shadow-lg">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $order->orderItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo e($item->product->image ?? 'https://via.placeholder.com/80'); ?>" 
                                     alt="<?php echo e($item->product->name); ?>" class="img-thumbnail" width="80" height="80"></td>
        ...
        <div class="text-end d-print-none">
            <a href="<?php echo e(route('restaurant.orders')); ?>" class="btn btn-secondary">Back to Orders</a>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.restaurant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/restaurant/partials/order-details.blade.php ENDPATH**/ ?>