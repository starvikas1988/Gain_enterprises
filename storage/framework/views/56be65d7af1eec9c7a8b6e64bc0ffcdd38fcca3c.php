...
<div class="container mt-4">
    ...
    <!-- Filter Section -->
    <form method="GET" action="<?php echo e(route('employee.orders')); ?>" class="mb-4">
        <div class="row">
            <!-- Search by Order ID -->
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="<?php echo e(route('employee.orders')); ?>" class="btn btn-secondary ms-2">Reset</a>
            </div>
        </div>
    </form>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('employee.orders.view', $order->id)); ?>" class="btn btn-info btn-sm view-order" data-id="<?php echo e($order->id); ?>">View</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Employee/orders.blade.php ENDPATH**/ ?>