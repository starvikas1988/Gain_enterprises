...
<div class="container mt-4">
    ...
    <form method="GET" action="<?php echo e(route('employee.purchases.dine_in')); ?>" class="mb-3 row g-3">
        <div class="col-md-4">
        ...
        <div class="col-md-2">
            ...
            <a href="<?php echo e(route('employee.purchases.dine_in')); ?>" class="btn btn-secondary">Reset</a>
        </div>
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/employee/purchases/dine_in.blade.php ENDPATH**/ ?>