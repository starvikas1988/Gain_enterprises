...
<div class="container mt-4">
    ...
    <!-- Add Table Form -->
    <form method="POST" action="<?php echo e(route('employee.tables.store')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <a href="<?php echo e(route('employee.tables.index')); ?>" class="btn btn-secondary">Cancel</a>
    </form>
</div>
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Employee/tables/create.blade.php ENDPATH**/ ?>