...
<style>
    ...
    $('#categorySelect').change(function () {
        ...
        if (categoryId) {
            $.ajax({
                url: "<?php echo e(route('employee.getProducts')); ?>",
                type: "POST",
...
function updateSubtotal(input) {
    ...
    $('#openPaymentModal').click(function() {
                ...
                $("#cart-body tr").each(function () {
                    let productId = $(this).data("product-id");
                    let restaurantId = "<?php echo e(auth()->user()->restaurant_id); ?>"; 
                    let qty = parseInt($(this).find(".qty-input").val());
        ...
        if (couponCode !== "") {
            $.ajax({
                url: "<?php echo e(route('employee.coupon.verify')); ?>", // Laravel route
                type: "POST",
                xhrFields: { withCredentials: true },
                data: { 
                    code: couponCode, 
    ...
    let restaurantId = "<?php echo e(auth()->user()->restaurant_id); ?>"; // Get logged-in restaurant ID
    ...
    $.ajax({
        url: "<?php echo e(route('employee.orders.place')); ?>", // Laravel route for saving order
        type: "POST",
        xhrFields: { withCredentials: true },
        data: {
            restaurant_id: "<?php echo e(auth()->guard('employee')->user()->restaurant_id); ?>",
...
function generateToken() {
    ...
    window.open(`/employee/generate-token/${orderId}`, '_blank');
}
...
<?php echo $__env->make('layouts.employee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/Employee/kot.blade.php ENDPATH**/ ?>