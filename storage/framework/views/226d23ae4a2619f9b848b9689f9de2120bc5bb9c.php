        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="tab-content">
					<form action="<?php echo e(route('restaurant.passwordchange')); ?>" method="POST">
						<?php echo csrf_field(); ?>
						<div class="row">
...
<?php echo $__env->make('layouts.restaurant', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gainenterprises\resources\views/restaurant/changepassword.blade.php ENDPATH**/ ?>