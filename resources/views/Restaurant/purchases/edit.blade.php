...
<div class="container mt-4">
    <h4>Edit Purchase</h4>
    <form method="POST" action="{{ route('restaurant.purchases.update', $order->id) }}">
        @csrf
        <div class="mb-3">
        ...
        <a href="{{ $order->table_id ? route('restaurant.purchases.dine_in') : route('restaurant.purchases.home_delivery') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
