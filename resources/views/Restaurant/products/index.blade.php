...
<div class="container mt-4">
    ...
    <a href="{{ route('restaurant.products.create') }}" class="btn btn-primary mb-3">Add New Product</a>

    <!-- Filter Section -->
    <form method="GET" action="{{ route('restaurant.products.index') }}" class="mb-4">
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="{{ route('restaurant.products.index') }}" class="btn btn-secondary ms-2">Reset</a>
            </div>
        </div>
    </form>
            ...
            <tbody>
                @forelse ($products as $product)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('restaurant.products.edit', $product->id) }}" class="btn btn-info btn-sm">Edit</a>
