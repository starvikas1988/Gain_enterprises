...
<div class="container mt-4">
    <div class="card shadow-lg">
        <div class="card-header bg-primary text-white d-flex justify-content-between">
            ...
            @endphp
            {{-- Check if the employee has permission to print orders --}}
            @if(collect($employeePermissions)->contains('permission_slug', 'print_orders'))
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ $item->product->image ?? 'https://via.placeholder.com/80' }}" 
                                     alt="{{ $item->product->name }}" class="img-thumbnail" width="80" height="80">
                            </td>
