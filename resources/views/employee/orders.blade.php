@extends('layouts.employee') {{-- Assuming you have an employee-specific layout --}}
...
<div class="container mt-4">
    ...
    <!-- Filter Section -->
    <form method="GET" action="{{ route('employee.orders') }}" class="mb-4">
        <div class="row">
            <!-- Search by Order ID -->
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="{{ route('employee.orders') }}" class="btn btn-secondary ms-2">Reset</a>
            </div>
        </div>
    </form>
            ...
            <tbody>
                @forelse ($orders as $order)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('employee.orders.view', $order->id) }}" class="btn btn-info btn-sm view-order" data-id="{{ $order->id }}">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
