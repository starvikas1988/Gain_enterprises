            ...
            <div class="col-sm-3">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h3 class="mt-3 mb-3">{{ $totalTodayStock  }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card widget-flat">
                    <div class="card-body">
                        ...
                        <h3 class="mt-3 mb-3">{{ $totalPurchaseCount  }}</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('employee.orders.view', $order->id) }}" class="btn btn-sm btn-primary">View</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
...
<script>
    ...
    $.ajax({
        url: "{{ route('employee.orders.updateStatus') }}",
        type: "POST",
        data: {
            _token: "{{ csrf_token() }}",
            order_id: orderId,
...
$(document).on("click", ".change-order-status", function() {
    ...
    $.ajax({
        url: "{{ route('employee.orders.changeStatus') }}",
        type: "POST",
        data: {
            _token: "{{ csrf_token() }}",
            order_id: orderId,
