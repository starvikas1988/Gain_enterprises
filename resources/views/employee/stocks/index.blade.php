...
<div class="container mt-4">
    ...
    <div class="mb-4 d-flex justify-content-between">
        <a href="{{ route('employee.stocks.create') }}" class="btn btn-primary">Add Stock</a>
        <a href="{{ route('employee.stocks.downloadSample') }}" class="btn btn-success">Download Sample Excel</a>
    </div>

    <form action="{{ route('employee.stocks.uploadBulk') }}" method="POST" enctype="multipart/form-data" class="mb-4">
        @csrf
    ...
    <form action="{{ route('employee.stocks.updateBulk') }}" method="POST">
        @csrf
